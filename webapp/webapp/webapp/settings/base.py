...
TILE_PROVIDER = 'http://tiles.swift.kg/osm_tiles/{z}/{x}/{y}.png'
NOMINATIM_URL = 'http://tiles.swift.kg/search.php'
LATITUDE = '42.878983'
LONGTITUDE = '74.587555'
LEAFLET_CONFIG = {
    'TILES': TILE_PROVIDER,
    'DEFAULT_CENTER': (float(LATITUDE), float(LONGTITUDE)),
    'DEFAULT_ZOOM': 13,
    'MIN_ZOOM': 3,
    'MAX_ZOOM': 18,
}
